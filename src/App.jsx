...
<style>{`@import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,500;0,600;1,300;1,400&family=Nunito:wght@300;400;600;700&display=swap'); *{box-sizing:border-box;margin:0;padding:0;-webkit-tap-highlight-color:transparent;} ::-webkit-scrollbar{width:0;} @keyframes fp0{0%,100%{transform:translate(0,0) scale(1)}50%{transform:translate(12px,-18px) scale(1.3)}} @keyframes fp1{0%,100%{transform:translate(0,0)}50%{transform:translate(-14px,20px)}} @keyframes fp2{0%,100%{transform:translate(0,0) scale(1)}33%{transform:translate(8px,14px) scale(0.8)}66%{transform:translate(-10px,-8px) scale(1.2)}} @keyframes pulse{0%,100%{box-shadow:0 0 0 0 rgba(86,171,145,0.4)}50%{box-shadow:0 0 0 10px rgba(86,171,145,0)}} @keyframes shimmer{0%{background-position:200% center}100%{background-position:-200% center}} @keyframes fadeUp{from{opacity:0;transform:translateY(18px)}to{opacity:1;transform:translateY(0)}} @keyframes orbit{from{transform:rotate(0deg)}to{transform:rotate(360deg)}} @keyframes heartPop{0%{transform:scale(1)}40%{transform:scale(1.45)}100%{transform:scale(1)}} .cw:nth-child(1){animation:fadeUp 0.4s 0.04s ease both} .cw:nth-child(2){animation:fadeUp 0.4s 0.10s ease both} .cw:nth-child(3){animation:fadeUp 0.4s 0.16s ease both} .cw:nth-child(4){animation:fadeUp 0.4s 0.22s ease both} .cw:nth-child(5){animation:fadeUp 0.4s 0.28s ease both} .cw:nth-child(6){animation:fadeUp 0.4s 0.34s ease both} .pc{transition:transform .25s,box-shadow .25s;}.pc:active{transform:scale(0.975);} .lb{transition:transform .2s,background .2s;}.lb:active{animation:heartPop .3s ease;} .nb{transition:all .2s;} input,textarea,select{outline:none;-webkit-appearance:none;} input:focus,textarea:focus{border-color:#56ab91!important;box-shadow:0 0 0 3px rgba(86,171,145,.15)!important;} button:hover{opacity:0.9;}`}</style>
